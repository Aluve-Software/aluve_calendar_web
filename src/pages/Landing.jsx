    ...
    return (
        ...
        <div className="relative min-h-screen lg:overflow-hidden overflow-visible justify-center">
            <div className="display flex flex-col bg-white justify-center w-full min-h-screen sm:flex-row flex-grow">
                <div className='bg-white lg:bg-lilac md:bg-lilac w-full md:pr-24 md:pl-20 md:w-2/3 flex-grow lg:pt-24 md:pt-24 lg:pl-32 lg:pr-80 text-left lg:text-white md:text-white sm:text-black'>
                ...
                <div className='bg-lilac lg:bg-white  md:bg-white w-full max-w-md sm:w-full flex-grow rounded-border '>

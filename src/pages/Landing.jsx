...
export default function Landing() {
  ...
  <div className="relative min-h-screen lg:overflow-hidden overflow-visible justify-center">
      <div className="display flex flex-col bg-white justify-center w-full min-h-screen sm:flex-row flex-grow">
          <div className='bg-lilac w-full md:pr-48  flex-grow pt-24 pl-32 pr-80 text-left lg:text-white md:text-white sm:text-black'>
              <div className='flex-grow'>
              <p className='lg:text-6xl font-bold text-4xl md:text-5xl flex-grow'>
                  Load shedding impacting your  <br/> team’s<br/> productivity?
              </p>

              <p className='text-2xl pt-16 pr-16 leading-none '>
                  Find the best time to collaborate with your team. Schedule a meeting. Send messages, plus more. <br/>Ready?
              </p>

              <div className='display flex row justify-space-around w-full gap-6 lg:text-2xl sm:text-xl pt-16'>
              ...
              <div className='relative -top-96 inset-full '>

...
const Footer = () => {
    ...
    return (
        <footer className="p-4 bg-yellow sm:p-6 dark:bg-gray-800">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy;{(new Date().getFullYear())} <a href="https://flowbite.com" target="_blank" class="hover:underline">Aluve Calendar App</a>. All Rights Reserved.
                    </span>
